...
<#
.SYNOPSIS
Exports Entra role assignments, including both active and eligible assignments.
...
- AssignmentId is used for tracking the unique object ID representing the role assignment, and this value is passed down to the expanded group members which helps with filtering in Splunk.
