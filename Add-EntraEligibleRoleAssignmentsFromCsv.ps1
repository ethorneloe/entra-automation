...
function Add-EntraEligibleRoleAssignmentsFromCsv {
    ...
    # -------------------------------------------------------
    # 1) Retrieve all Role Definitions
    # -------------------------------------------------------
    try {
    ...
    # -------------------------------------------------------
    # 2) Import CSV, clean/trims, then gather unique roles and UPNs
    # -------------------------------------------------------
    try {
    ...
    foreach ($assignment in $assignments) {
        ...
        # -------------------------------------------------------
        # Check if there's already an eligibility schedule
        # -------------------------------------------------------
        ...
        # -------------------------------------------------------
        # Create the eligibility schedule
        # -------------------------------------------------------
        try {
